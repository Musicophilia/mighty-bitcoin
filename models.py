...
class utility_model(object):
    def __init__(self, btc_f_stolen = 0.05, btc_f_owned_0 = 0.10, total_btc = 16000000,
        ...
        self.default_exchange_rate = default_exchange_rate
    ...
    def _get_attack_value(self):
        ...
        btc_to_usd_withdraw = btc_to_usd_exchange_rate(self.attack_time + self.withdraw_btc_delta,
                                                       self.btc_f_stolen,
                                                       default_exchange_rate = self.default_exchange_rate)
...
def get_attack_utility(btc_f_stolen = 0.05, btc_f_owned_0 = 0.10, mining_power = 0.2,
    ...
    model = utility_model(btc_f_stolen = btc_f_stolen, btc_f_owned_0 = btc_f_owned_0,
            ...
            discount_rate = discount_rate, default_exchange_rate = default_exchange_rate)
